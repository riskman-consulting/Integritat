...
const Clients = () => {
  ...
  const fetchClients = async () => {
    try {
      ...
      if (response.success) {
        ...
        const mappedData = response.data.map(client => ({
          ...client,
          ...
          incDate: client.incorporation_date,
          businessNature: client.business_nature,
          taxId: client.tax_id,
          priorAuditor: client.prior_auditor,
          // DB status is InitCase, Frontend usually expects it or just strings
          status: client.status,
          projects: [] // Projects not fetched yet
        }));
        setData(mappedData);
      }
    } catch (error) {
  ...
  return (
    <div className="p-6 bg-slate-50 min-h-screen font-sans">
      ...
      {/* Render modals via portal to document.body to ensure proper z-index */}
      {isAddModalOpen && createPortal(
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex justify-center items-center z-[9999] p-4 transition-all">
      ...
      {isProjectModalOpen && selectedClient && createPortal(
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl">
            ...
            <div className="p-0 max-h-[60vh] overflow-y-auto">
              <div className="p-6 text-center text-slate-500">
                <p>Projects feature coming soon for backend integration.</p>
              </div>
            </div>
